...
async function initDb() {
  ...
  const defaultScreens = [
    ["P1-C1", "P1", 128, 512, "vertical", "contain", 0, 0],
    ["P1-C2", "P1", 192, 512, "vertical", "contain", 128, 0],
    ["P1-C3", "P1", 256, 512, "vertical", "contain", 320, 0],
    ["P1-C4", "P1", 128, 512, "vertical", "contain", 576, 0],
    ["P1-C5", "P1", 128, 512, "vertical", "contain", 704, 0],
    ["P1-C6", "P1", 320, 480, "vertical", "contain", 0, 0],
    ["PB-C10", "PB", 704, 512, "vertical", "contain", 0, 0],
    ["PB-C11", "PB", 192, 512, "vertical", "contain", 0, 0],
    ["PB-C12", "PB", 256, 512, "vertical", "contain", 0, 0],
  ];
